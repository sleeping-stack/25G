...
void Write_frequency(uint8_t Channel, uint32_t Freq)
{
    ...
    uint32_t Temp;
    Temp = (uint32_t)Freq *
           8.589934592; // The input frequency factor is divided into four bytes.  4.294967296=(2^32)/500000000
...
/**
 * @brief  AD9959 Error handler (LED code removed)
 */
void AD9959_error(void)
{
    // No operation - error handling can be customized here
}
